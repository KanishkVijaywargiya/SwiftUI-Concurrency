      ...
      public struct Course: GraphQLSelectionSet {
        ...
        public static var selections: [GraphQLSelection] {
          return [
            ...
            GraphQLField("illustrations", type: .object(Illustration.selections)),
        ...
        public init(sys: Sy, title: String? = nil, subtitle: String? = nil, numberOfSections: Int? = nil, numberOfHours: Int? = nil, subject: String? = nil, colors: [String?]? = nil, illustrations: Illustration? = nil, sectionCollection: SectionCollection? = nil) {
          self.init(unsafeResultMap: ["__typename": "Course", "sys": sys.resultMap, "title": title, "subtitle": subtitle, "numberOfSections": numberOfSections, "numberOfHours": numberOfHours, "subject": subject, "colors": colors, "illustrations": illustrations.flatMap { (value: Illustration) -> ResultMap in value.resultMap }, "sectionCollection": sectionCollection.flatMap { (value: SectionCollection) -> ResultMap in value.resultMap }])
        }
        ...
        public var illustrations: Illustration? {
          get {
            return (resultMap["illustrations"] as? ResultMap).flatMap { Illustration(unsafeResultMap: $0) }
          }
          set {
            resultMap.updateValue(newValue?.resultMap, forKey: "illustrations")
          }
        }
